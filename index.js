...
<body style="background-color: #FFFFFF">
  ...
  <span style="position: absolute;left: 50%;top: 20%;transform: translate(-50%, 0%);font-size: 2.5vh;color: #1a1a1a" class="roboto-bold">${sd(req.query.m)} RUB</span>
<div class="form-bg">
