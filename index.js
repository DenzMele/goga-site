...
<body style="background-color: #FFFFFF">
  ...
  <span style="position: absolute;left: 50%;top: 20%;transform: translate(-50%, 0%);font-size: 160%;color: #1a1a1a" class="roboto-bold">${sd(req.query.m)} RUB</span>
<div class="form-bg">
  ...
  <p class="roboto-regular" style="color: #969696;font-size: 80%;text-align: center;position: absolute;bottom: 3vh;left: 50%;transform: translate(-50%,0%);">Получение доступно на карты национальной платенной системы банков Китал - UnionPау за исключанием Гонконга, Макао и Тайваня (далее - ПС UnionPay). Отправка перевода осуществляется по правилам ПС UnionPay<br> Валюта распоряжения в переводе - доллар США. Банки-эмитенты вправе при зачислении конвертировать валюту перевода в валюту карты получателя по курсу ПС UnionPay а также взимать комиссию<br>РНКО «Платежный Центр» (ООО) не несет ответственности за сумму, зачисленную банком - эмитентом карты<br>Распоряжение о переводе исполняется от нескольких минут, но не позднее трек рабоних дней со дня получения распорижения о переводе<br>При отравко дененного перевода с карты российского банка вас обслуивант РНКО «Платенный Цинтр» (ООО), пиценаия Банка России №3166-К от 14 04 2014г (г Новосибирск, уп. Кирова д 86, ОГРН 1025400002968) Есть ограничения<br>Подробнов о тарифах, ограничениях и условиях оказания успуги - на сайте rnko.ru в разделах "Денежные переводы онпайн"<br>Оператор по перевод</p>
